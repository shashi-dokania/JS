...
function animalMaker(inputType, inputSuperPower, inputCanFly) {
  var obj = {};
  obj.type = inputType;
  obj.superPower = inputSuperPower;
  obj.canFly = inputCanFly;
  obj.createdBy = 'Preston';
  return obj;
