...
//2
console.log(bikeCopy.sparklerCount);
...
//flawless
console.log(myBike.condition);
// What do we expect noBikeHere to be? 
console.log(noBikeHere)
//bikeCopy.condition
console.log(bikeCopy.condition);
