...
var bbqMeatCooker = function() {
  ...
  console.log('we\'re inside bbqMeatCooker with chef',chef + ' whose favorite dish is',favoriteDish);
...
console.log('global scope address: ',address);
...
vegetarianCorner = function() {
  ...
  //--1517 Shattuck Ave
    // Why?
    //if we console log address here, it looks for the variable within the function first and if it doesnt find it, it looks at the global variables with name address and logs the value of that variable.
    console.log(address)
};
vegetarianCorner();
...
bbqMeatCooker = function() {
  ...
  // What is the value of address here? 
  //--1610 Shattuck Ave
    // Why? It looks at all the variable called address in the local scope and if it finds the variable, it returns the value of that variable and does not bother to look outside the function.
    console.log(address)
  // What is the value of chef here?
  //-- Raka
    // Why?
    //--It looks at all the variable called address in the local scope and if it finds the variable, it returns the value of that variable and does not bother to look outside the function.
    //console.log(chef)
...
//func1();
//inside of our closure scope, i is still:',i,'val is:',testArr[i];
...
function nameMaker(firstName) {
  ...
  var fullName = firstName + " Thinklestein";
  //function reunionGreeter(lastName) {
    return function(){console.log("Welcome to the party", firstName);}
  //}
};
var greeting = nameMaker("Shashi");
greeting("Dokania");
